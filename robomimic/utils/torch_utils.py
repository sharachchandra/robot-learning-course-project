...
class SchedulerLearningRateWarmUp(optim.lr_scheduler._LRScheduler):
    """
    Scheduler with learning rate warm-up introduced specifically for the training of
    ...
    def get_lr(self) -> float:
        lr = self.max_lr * \
             min((self._step_count/self.warmup_steps)**(-self.decay_power), 
